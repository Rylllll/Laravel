    ...
    <section class="min-h-screen flex items-center justify-center bg-2b2d42">
        ...
        <div class="bg-gray-100 flex rounded-2xl shadow-2xl max-w-7xl p-5 items-center text-black  ">
            ...
            <div class="md:w-1/2 px-8 md:px-16 ">
                ...
                <form action="/login" class="flex flex-col gap-4" method="POST" id="loginForm">
                    @csrf
                    <input class="p-2 px-7 mt-8 rounded-xl border border-blue-400" id="username" type="email" name="email" placeholder="Email" value="{{old('email')}}" required>
                    @error('email')
