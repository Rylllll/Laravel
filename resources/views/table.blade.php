        ...
        <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="./dashboard.html">
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors" href="#">
                        <div class="bg-black shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
    ...
    <main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
        ...
        <div class="w-full px-6 py-6 mx-auto">
            ...
            <table id="data-table" class="table-fixed w-full">
                <thead>
                    <tr>
                        <th class="w-1/4 px-4 py-2 border hidden">Id</th>
                        <th class="w-1/4 px-4 py-2 border">Title</th>
                        <th class="w-1/4 px-4 py-2 border">Image</th>
                        <th class="w-1/4 px-4 py-2 border">Information</th>
                    </tr>
                </thead>

                <tbody class="text-center w-1/4 px-4 py-2 border">
