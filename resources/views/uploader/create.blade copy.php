    ...
    <main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
        ...
        <div class="p-4 mt-10">
            ...
            <div class="p-4 text-gray-900 bg-white rounded-2xl shadow-xl">
                <div class="p-4 flex">
                    <h1 class="text-xl font-bold">Upload Picture</h1>

                    <div class="flex items-center md:ml-auto md:pr-4">

                    </div>
                    <a class="hidden md:block  group relative inline-flex items-center overflow-hidden rounded bg-[#212121] px-8 py-3 text-white focus:outline-none focus:ring active:bg-[#212121]"
                        href="{{ URL::to('uploads') }}">
                ...
                <form method="POST" action="{{ url('uploads') }}" enctype="multipart/form-data">
                    ...
                    <div class=" rounded-2xl sm:overflow-hidden sm:rounded-md">
                        <div class=" bg-white  sm:p-6">
                            ...
                            <div>
                                <label for="about" class="block text-sm font-bold leading-6 text-gray-900">Title of
                                    the
                                    image</label>
